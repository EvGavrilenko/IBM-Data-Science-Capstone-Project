...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
        ...
        searchable=True
                                ...
                                def get_pie_chart(entered_site):
                                    filtered_df_all = spacex_df[spacex_df['class'] == 1].groupby(['Launch_Site'], as_index=False)
                                    filtered_df_site = spacex_df[spacex_df['Launch_Site'] == value].groupby(['class'], as_index=False)
                                    filtered_df_all = filtered_df_all
                                    filtered_df_site = filtered_df_site
                                    if entered_site == 'ALL':
